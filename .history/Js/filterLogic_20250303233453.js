...
function applyFilter() {
  ...
  if (userOption === "AsteroidByID") {
    ...
    userInput = document.getElementById("topN").value;
    url = `http://localhost:8080/getClosestAsteroidsByDistance?topN=${userInput}`;
  } else if (userOption === "getFastestAsteroids") {
    userInput = document.getElementById("topN").value;
    url = `http://localhost:8080/getFastestAsteroids?topN=${userInput}`;
  } else if (userOption === "getLargestAsteroids") {
    userInput = document.getElementById("topN").value;
    url = `http://localhost:8080/getLargestAsteroids?topN=${userInput}`;
  }
