        ...
        ? nearEarthObjects
            .map((asteroid) => {
              ...
              <tr>
                ...
                <td>${closeApproach?.close_approach_date}</td>
                <td>${closeApproach?.miss_distance?.kilometers}</td>
                <td>${closeApproach?.miss_distance?.lunar}</td>
                <td>${closeApproach?.miss_distance?.miles}</td>
                <td>${closeApproach?.relative_velocity?.kilometers_per_hour}</td>
              </tr>
            `;
            })
            .join("")
