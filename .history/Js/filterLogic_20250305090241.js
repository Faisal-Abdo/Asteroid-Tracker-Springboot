  ...
  fetchDataWithDefaultTimeout(url, requestOptions)
    ...
    .then((data) => {
      ...
      nearEarthObjects = nearEarthObjects.map((asteroid) => ({
        ...
        closeApproachDate:
          asteroid.closeApproachData?.[0]?.close_approach_date || "N/A",
        missDistanceKm:
          asteroid.closeApproachData?.[0]?.miss_distance?.kilometers || "N/A",
        speedKmh:
          asteroid.closeApproachData?.[0]?.relative_velocity
            ?.kilometers_per_hour || "N/A",
